      ...
      <div className="min-h-screen bg-[#062011] p-6 flex flex-col gap-12  py-50 sm:py-35">
        ...
        <section className="flex flex-col sm:flex-row items-center gap-4 justify-center">
          ...
          <button
            ...
            onClick={() =>hendellanguag("Hindi")}
          >
           Hindi
          </button>
          <button
            className={`${language.includes("")?' bg-fuchsia-800':'bg-red-600'} text-white px-2 py-1 rounded-full hover:bg-blue-700 transition`}
            onClick={() =>hendellanguag("English")}
          >
           English
          </button>
        </section>
